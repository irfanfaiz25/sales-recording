<div class="fade-in">
    <div class="page-header">
        ...
        <p class="page-subtitle">Perbarui informasi item yang sudah ada dalam sistem</p>
    </div>
                        ...
                        <div class="space-x-4 space-y-4">
                            @if ($image)
                                <div class="relative inline-block">
                                    <div
                                        class="bg-gradient-to-br from-green-100 to-green-200 p-4 rounded-2xl shadow-lg">
                                        <div class="text-center mb-2">
                                            <span class="text-sm font-semibold text-green-800">Gambar Baru</span>
                                        </div>
                                        <img src="{{ $image->temporaryUrl() }}" alt="Preview"
                                            class="w-40 h-40 object-cover rounded-xl border-4 border-white shadow-md">
                                        <button type="button" wire:click="$set('image', null)"
                                            class="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center shadow-lg transition-all duration-200 transform hover:scale-110"
                            ...
                            @if ($currentImage)
                                <div class="relative inline-block">
                                    <div class="bg-gradient-to-br from-blue-100 to-blue-200 p-4 rounded-2xl shadow-lg">
                                        <div class="text-center mb-2">
                                            <span class="text-sm font-semibold text-blue-800">Gambar Saat Ini</span>
                                        </div>
                            ...
                            @if (!$image && !$currentImage)
                                <div
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            <p class="text-gray-600 font-medium">Belum ada gambar</p>
                                            <p class="text-gray-400 text-sm">Upload gambar untuk mengganti</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
